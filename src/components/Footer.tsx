...
import { useAdvocacyData } from '@/data/data_provider';
      ...
      <div className="max-w-6xl mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0 items-center mr-4">
            ...
            <a href="https://x.com/alm_world" target='_blank' className="text-gray-400 hover:text-yellow-500 transition-colors">
            ...
            <a href="https://github.com/almworld/alllivesmatter.world" target='_blank' className="text-gray-400 hover:text-yellow-500 transition-colors ">
