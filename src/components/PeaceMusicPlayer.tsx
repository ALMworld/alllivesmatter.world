...
const PeaceMusicPlayer = () => {
    ...
    if (playerState === 'hidden') {
        return (
            ...
            // </button>
            <div
                className="fixed bottom-4 right-4 z-50 w-12 h-12 rounded-full bg-[#d20033] text-white flex items-center justify-center shadow-lg bg-opacity-80 flex items-center justify-center cursor-pointer"
                onClick={toggleExpand}             >
                <Music size={24} color="yellow"  />
            </div>
        );
    }
